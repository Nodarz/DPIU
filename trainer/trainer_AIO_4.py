...
from models.model_AIO_4 import model_encdec
from trainer.evaluations_4 import *
...
class Trainer:
    def __init__(self, config):
        ...
        self.folder_test = 'training/training_' + config.mode + '/' + self.name_test + '_' + config.info + '_4'
    ...
    def fit(self):
        ...
        if self.config.mode == 'intention':
            ...
            model_pretrain_intention = torch.load('./training/training_intention/2023-04-22_try1_4/model_ae_2023-04-22')
            self.mem_n2n.load_state_dict(model_pretrain_intention.state_dict())
            self.mem_n2n.generate_memory(self.train_dataset, filter_memory=True, threshold_distance=0.25)
